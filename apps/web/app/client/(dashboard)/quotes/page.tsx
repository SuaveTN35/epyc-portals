    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="flex items-center px-4 py-2 bg-epyc-primary text-white rounded-lg hover:bg-epyc-secondary transition-colors"
        >
      ...
      {quotes.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <Link
            href="/client/deliveries/new"
            className="inline-flex items-center px-6 py-3 bg-epyc-primary text-white rounded-lg hover:bg-epyc-secondary transition-colors"
          >
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Link
                        href={`/client/deliveries/new?from_quote=${quote.id}`}
                        className="flex items-center px-4 py-2 bg-epyc-accent text-white rounded-lg hover:bg-epyc-secondary transition-colors text-sm font-medium"
                      >
                        Book Now
