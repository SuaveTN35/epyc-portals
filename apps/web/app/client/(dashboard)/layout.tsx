...
const navigation = [
  { name: 'Dashboard', href: '/client/deliveries', icon: Home },
  { name: 'New Delivery', href: '/client/deliveries/new', icon: Truck },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center space-x-2 px-6 py-4 border-b">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold text-epyc-dark">Client Portal</span>
            </Link>
          </div>
